...
titre: 'Understanding the Needs of a Mobile Phone-Based Telemonitoring Program for
  Pregnant Women at High Risk for Pre-Eclampsia: Interpretive Qualitative Description
  Study.'
...
CONCLUSIONS: Our findings highlight the perceived feasibility of a mobile phone-based TM program for pregnant women at high risk for pre-eclampsia and provide insights that can be directly used for the design of future TM programs with the aim of reducing mortality and morbidity from pre-eclampsia and eclampsia in LMICs.

[Référence d'origine](https://pubmed.ncbi.nlm.nih.gov/35200152/)
