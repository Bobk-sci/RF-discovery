...
annee: 2024
journal: ''
titre: 1.7 GHz long-term evolution radiofrequency electromagnetic field with stable
  power monitoring and efficient thermal control has no effect on the proliferation
  of various human cell types.
...
[Référence d'origine](https://pubmed.ncbi.nlm.nih.gov/38713716/)
